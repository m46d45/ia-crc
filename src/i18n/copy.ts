...
export const COPY = {
  en: {
    ...
    publicationsPage: {
      ...
      preview: "Citation",
      incomplete:
        "This address is not in Crossref, so the title was not filled automatically. Enter the details from the page, then add it.",
      citeTitle: "Title",
      citeAuthors: "Authors",
      citeYear: "Year",
      citeVenue: "Journal or venue",
      citeKind: "Type",
      kindArticle: "Article",
      kindBook: "Book",
      kindChapter: "Chapter",
      kindConference: "Conference paper",
    ...
    statsPage: {
      ...
      venues: "Venues",
      news: "With a note",
      since: "Since the forum was founded in 2023",
      membersHint: "Authors who are also IA-CRC members",
      venuesHint: "Journals and venues on the list",
      newsHint: "Papers that carry a member note",
      byYear: "Papers by year",
      venueTitle: "Venues",
    ...
    footer: {
      ...
      contact: "Contact",
      links: "Navigate",
      visitors: "people have visited this site",
  ...
  id: {
    ...
    publicationsPage: {
      ...
      preview: "Sitasi",
      incomplete:
        "Alamat ini tidak ada di Crossref, jadi judul tidak terisi otomatis. Isi data dari halaman, lalu tambahkan.",
      citeTitle: "Judul",
      citeAuthors: "Penulis",
      citeYear: "Tahun",
      citeVenue: "Jurnal atau penerbit",
      citeKind: "Jenis",
      kindArticle: "Artikel",
      kindBook: "Buku",
      kindChapter: "Bab",
      kindConference: "Makalah konferensi",
    ...
    statsPage: {
      ...
      venues: "Penerbit",
      news: "Dengan catatan",
      since: "Sejak forum didirikan pada 2023",
      membersHint: "Penulis yang juga anggota IA-CRC",
      venuesHint: "Jurnal dan penerbit di daftar",
      newsHint: "Makalah yang memuat catatan anggota",
      byYear: "Makalah per tahun",
      venueTitle: "Penerbit",
    ...
    footer: {
      ...
      contact: "Kontak",
      links: "Navigasi",
      visitors: "orang telah mengunjungi situs ini",
      rights: "Indonesia–Australia Collaborative Research in Construction.",
    },
    aboutPage: {
